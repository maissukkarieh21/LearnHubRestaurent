...
namespace LearnHubRestaurent.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoryName,ImageFile,Id")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("CategoryName,ImageFile,Id,ImagePath")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (category.ImageFile != null)
                    {
                        ...
                        {
                            var previousImagePath = Path.Combine(_webHostEnviroment.WebRootPath, "Images", existingCategory.ImagePath);
        ...
        public async Task<IActionResult> DeleteConfirmed(decimal id)
        {
            ...
            {
                var imagePath = Path.Combine(_webHostEnviroment.WebRootPath, "Images", category.ImagePath);
