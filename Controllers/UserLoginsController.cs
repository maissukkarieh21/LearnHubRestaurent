...
namespace LearnHubRestaurent.Controllers
{
    public class UserLoginsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserName,Password,RoleId,Id,CustomerId")] UserLogin userLogin)
        {
            ...
            ViewData["CustomerId"] = new SelectList(_context.Customerrs, "Id", "Id", userLogin.CustomerId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("UserName,Password,RoleId,Id,CustomerId")] UserLogin userLogin)
        {
            if (id != userLogin.Id)
            {
                return NotFound();
