...
namespace LearnHubRestaurent.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Namee,Sale,Price,CategoryId,Id")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Namee,Sale,Price,CategoryId,Id")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
